...
--
-- Name: codes idx_24582_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.codes
    ADD CONSTRAINT idx_24582_codes_pkey PRIMARY KEY (id);


--
-- Name: sessions idx_24587_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.sessions
    ADD CONSTRAINT idx_24587_sessions_pkey PRIMARY KEY (id);


--
-- Name: kids_codes idx_24592_kids_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.kids_codes
    ADD CONSTRAINT idx_24592_kids_codes_pkey PRIMARY KEY (id);


--
-- Name: kids_parents idx_24597_kids_parents_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.kids_parents
    ADD CONSTRAINT idx_24597_kids_parents_pkey PRIMARY KEY (id);


--
-- Name: gradients idx_24600_gradients_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.gradients
    ADD CONSTRAINT idx_24600_gradients_pkey PRIMARY KEY (id);


--
-- Name: rooms idx_24605_rooms_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.rooms
    ADD CONSTRAINT idx_24605_rooms_pkey PRIMARY KEY (id);


--
-- Name: messages idx_24610_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.messages
    ADD CONSTRAINT idx_24610_messages_pkey PRIMARY KEY (id);


--
-- Name: room_users idx_24615_room_users_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.room_users
    ADD CONSTRAINT idx_24615_room_users_pkey PRIMARY KEY (id);


--
-- Name: deliveries idx_24618_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.deliveries
    ADD CONSTRAINT idx_24618_deliveries_pkey PRIMARY KEY (id);


--
-- Name: friends idx_24621_friends_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.friends
    ADD CONSTRAINT idx_24621_friends_pkey PRIMARY KEY (id);


--
-- Name: images idx_24626_images_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.images
    ADD CONSTRAINT idx_24626_images_pkey PRIMARY KEY (id);


--
-- Name: responses idx_24631_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.responses
    ADD CONSTRAINT idx_24631_responses_pkey PRIMARY KEY (id);


--
-- Name: questions idx_24636_questions_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.questions
    ADD CONSTRAINT idx_24636_questions_pkey PRIMARY KEY (id);


--
-- Name: attempts idx_24641_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.attempts
    ADD CONSTRAINT idx_24641_attempts_pkey PRIMARY KEY (id);


--
-- Name: users idx_24644_users_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT idx_24644_users_pkey PRIMARY KEY (id);


--
-- Name: quizzes idx_24653_quizzes_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.quizzes
    ADD CONSTRAINT idx_24653_quizzes_pkey PRIMARY KEY (id);


--
-- Name: postcards idx_24659_postcards_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.postcards
    ADD CONSTRAINT idx_24659_postcards_pkey PRIMARY KEY (id);


--
-- Name: threads idx_24665_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.threads
    ADD CONSTRAINT idx_24665_threads_pkey PRIMARY KEY (id);


--
-- Name: bots idx_24670_bots_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.bots
    ADD CONSTRAINT idx_24670_bots_pkey PRIMARY KEY (id);


--
-- Name: notes idx_24676_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: appuser
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT idx_24676_notes_pkey PRIMARY KEY (id);


--
-- Name: idx_24587_sqlite_autoindex_sessions_1; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24587_sqlite_autoindex_sessions_1 ON public.sessions USING btree (key);


--
-- Name: idx_24615_sqlite_autoindex_room_users_1; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24615_sqlite_autoindex_room_users_1 ON public.room_users USING btree (room_id, user_id);


--
-- Name: idx_24618_sqlite_autoindex_deliveries_1; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24618_sqlite_autoindex_deliveries_1 ON public.deliveries USING btree (message_id, recipient_id);


--
-- Name: idx_24621_uidx_friends_a_b; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24621_uidx_friends_a_b ON public.friends USING btree (a_id, b_id);


--
-- Name: idx_24631_sqlite_autoindex_responses_1; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24631_sqlite_autoindex_responses_1 ON public.responses USING btree (attempt_id, question_id);


--
-- Name: idx_24644_sqlite_autoindex_users_1; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24644_sqlite_autoindex_users_1 ON public.users USING btree (username);


--
-- Name: idx_24644_sqlite_autoindex_users_2; Type: INDEX; Schema: public; Owner: appuser
--

CREATE UNIQUE INDEX idx_24644_sqlite_autoindex_users_2 ON public.users USING btree (email);
